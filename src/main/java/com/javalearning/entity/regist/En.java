...
public class En {
    ...
    public En(String orgcode, String regno, String cnname, String enname, String contactman, String contacttel, String regcap, String outregcap, String regcry, String usercode, String regdate) {
        this.orgcode = orgcode;
        this.regno = regno;
        this.cnname = cnname;
        this.enname = enname;
